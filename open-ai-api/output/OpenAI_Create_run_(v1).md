# [Create run (v1) Legacy](/docs/api-reference/runs-v1/createRun)
post https://api.openai.com/v1/threads/{thread_id}/runs 
Create a run. 
## Path parameters 
| Parameter | Type   | Required | Description|
| --- | --- | --- | --- |
| thread_id | string | Required | The ID of the thread to run.| 
## Request body 
| Parameter | Type   | Required | Description|
| --- | --- | --- | --- |
...
| additional_messages | array or null | Optional | Adds additional messages to the thread before creating the                   run.| 
